...
func (l *prettyProcessLogger) ProcessStart(msg string) {
...
func (l *prettyProcessLogger) ProcessFail() {
	p := l.processes.pop()
	if p != nil {
...
func (l *prettyProcessLogger) ProcessEnd() {
	p := l.processes.pop()
	if p != nil {
...
func (l *wrappedProcessLogger) ProcessStart(msg string) {
